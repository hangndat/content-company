/**
 * Experiment types — verify against orchestrator/src/dashboard/queries/experiments-overview.ts
...
// orchestrator/src/dashboard/queries/experiments-overview.ts ExperimentOverviewItem
...
export interface ExperimentStatusActionResponse {
  id: string;
  status: string;
}

export interface ExperimentPromoteResponse {
  id: string;
  promoted: { armId: string; promptVersion: number };
}
